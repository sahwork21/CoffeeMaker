...
/**
 * Controller class for the URL mappings for CoffeeMaker's Customer role. The
 * controller returns the approprate HTML page in the
 * /src/main/resources/templates/(customer)? folder. For a
 *
...
public class CustomerController {
    ...
    /**
     * On a GET request to /customer/customer.js, the CustomerController will
     * return /src/main/resources/templates/customer/customer.js
     *
     * @param model
     *            underlying UI model
     * @return contents of the page
     ...
     * will return /src/main/resources/templates/customer/order/order.html
     *
     * @param model
     *            underlying UI model
